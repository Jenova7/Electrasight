...
var defaultLanguage = localStorage.getItem("insight-language") || "en",
    defaultCurrency = localStorage.getItem("insight-currency") || "ECA";
    ...
    .controller("CurrencyController", function($scope, $rootScope, Currency) {
        ...
        $rootScope.currency.getConvertion = function(value) {
            if (value = 1 * value, !isNaN(value) && "undefined" != typeof value && null !== value) {
                ...
                var response;
                return "USD" === this.symbol ? response = _roundFloat(value * this.factor, 2) : "ECA" === this.symbol ? (this.factor = 1e3, response = _roundFloat(value * this.factor, 5)) : "uECA" === this.symbol ? (this.factor = 1e6, response = _roundFloat(value * this.factor, 2)) : (this.factor = 1, response = value), 1e-7 > response && (response = response.toFixed(8)), response + " " + this.symbol
            }
            return "value error"
            ...
            }) : $rootScope.currency.factor = "mECA" === currency ? 1e3 : "uECA" === currency ? 1e6 : 1
